...
| Documentation pass | Partial — §36 stubs + CHANGELOG/CONTRIBUTING + RTL checklist; **Tracking/Appearance/Catalogs/Rules/Sorting/Identity narratives expanded**; remaining §36 depth still Open |
