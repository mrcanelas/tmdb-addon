...
| Accessibility pass | Partial — Catalog Studio / Search & AI / **Rules & Sorting preview errors** keep the page; live regions on primary mutation feedback; broader pass Open |
...
| Documentation pass | Partial — §36 stubs + CHANGELOG/CONTRIBUTING + RTL checklist; major domain narratives expanded (incl. **Configuration/Profiles**); remaining §36 depth still Open |
