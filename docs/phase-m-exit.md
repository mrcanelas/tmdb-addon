...
| UX review of configure primary pages | Partial — primary pages on layered layout; Sorting loads saved plan; **Overview legacy import (dry-run + confirm)**; residual polish Open |
