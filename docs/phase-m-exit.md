...
| UX review of configure primary pages | Partial — Overview legacy import (dry-run + confirm); **session cache updated after import**; Sorting loads saved plan; residual polish Open |
