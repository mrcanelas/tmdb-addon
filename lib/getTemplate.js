...
async function landingTemplate(manifest) {
  ...
  return `
   ...
   <head>
      ...
      <link rel="shortcut icon" href="https://www.themoviedb.org/assets/2/favicon-32x32-543a21832c8931d3494a68881f6afcafc58e96c5d324345377f3197a37b367b5.png" type="image/x-icon">
	...
	<body>
      ...
      function generateInstallLink() {
        ...
        if (language && language !== 'en-US') {
          installLink.href = 'stremio://' + window.location.host + '/' + adult + ':' + language + '/manifest.json';
        } else {
