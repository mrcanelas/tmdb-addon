...
console.log('2. Keep METALAYER_ENCRYPTION_KEY unchanged (or follow vault rotation docs).');
console.log('3. Review CHANGELOG / phase exit docs for breaking alpha/beta changes.');
console.log('4. Restart the API process after image/package updates.');
console.log('5. If rotating encryption keys, run: pnpm metalayer:vault-reencrypt --dry-run');
console.log('');
