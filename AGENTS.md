...
1. **UX / a11y / i18n / performance / security** hardening (Phase M checklist) — in progress; **migration fixtures Done**; **perf harness MVP Done**; **provider health registry Done**; **security hardening MVP**; **FRC Appearance background**; **Search & AI i18n seeds/lines**
...
**Status (2026-07-12): complete.** Key rotation tooling shipped (`parseEncryptionKeyRingFromEnv` + vault reencrypt CLI). See `docs/phase-b-exit.md`.
...
- [x] Profiles are supported end-to-end (UI + profile manifest + profile-scoped catalog/meta).
