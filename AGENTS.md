...
1. **UX / a11y / i18n / performance / security** hardening (Phase M checklist) — in progress; prior MVPs Done; **feature freeze Done**; **RTL checklist landed** (visual pass Open); formal security sign-off Open
