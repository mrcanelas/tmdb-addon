...
1. **UX / a11y / i18n / performance / security** hardening (Phase M checklist) — in progress; prior MVPs Done; **docs §36 seed Partial**; **a11y live regions**; **Inspector attempt reason codes**; RTL visual audit Open
