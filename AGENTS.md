...
1. **UX / a11y / i18n / performance / security** hardening (Phase M checklist) — in progress; **migration fixtures Done**; **perf harness MVP Done**; **provider health registry Done**
